...
CREATE TABLE ROTI(
    ...
    FK_RESEP VARCHAR2(10) REFERENCES SUPPLIER(ID) NOT NULL
);
...
-- BAHAN
INSERT INTO BAHAN VALUES(1, 'KOEPOE KOEPOE', 5, 2, 1);
INSERT INTO BAHAN VALUES(2, 'SEDAP KUE', 3, 1, 1);
INSERT INTO BAHAN VALUES(3, 'HERCULES', 5, 2, 2);
INSERT INTO BAHAN VALUES(4, 'SEGITIGA BIRU', 3, 3, 2);
INSERT INTO BAHAN VALUES(5, 'CAKRA KEMBAR', 4, 3, 2);
INSERT INTO BAHAN VALUES(6, 'KUNCI BIRU', 4, 3, 3);
INSERT INTO BAHAN VALUES(7, 'ANCHOR', 10, 4, 4);
INSERT INTO BAHAN VALUES(8, 'ELLE VIRE', 10, 4, 4);
INSERT INTO BAHAN VALUES(9, 'ORCHID', 6, 4, 5);
INSERT INTO BAHAN VALUES(10, 'BLUE BAND', 10, 5, 5);
INSERT INTO BAHAN VALUES(11, 'PALMIA', 8, 5, 6);
INSERT INTO BAHAN VALUES(12, 'DIAMOND UHT', 5, 6, 8);
INSERT INTO BAHAN VALUES(13, 'GREENFIELD SKIMMED', 5, 6, 9);
INSERT INTO BAHAN VALUES(14, 'DANCOW', 10, 7, 10);
INSERT INTO BAHAN VALUES(15, 'INDOMILK', 10, 7, 11);
INSERT INTO BAHAN VALUES(16, 'NEVADA GOLD', 8, 8, 9);
...
-- D_RESEP
INSERT INTO D_RESEP VALUES(1, 1, 3, 'GRAM');
INSERT INTO D_RESEP VALUES(1, 2, 1, 'GRAM');
...
-- ROTI
INSERT INTO ROTI VALUES(1, 'CROISSANT', 'A VERY EXQUISITE BREAD', 9000, 1, 1, 1);
INSERT INTO ROTI VALUES(2, 'RAISIN TOAST', 'HEALTHY!', 16000, 1, 2, 2);
INSERT INTO ROTI VALUES(3, '', '', 0, 0, 0, 0);
INSERT INTO ROTI VALUES(4, '', '', 0, 0, 0, 0);
...
-- KARYAWAN
INSERT INTO KARYAWAN VALUES(1, 'BudiR', 'BudiR', 'Budi Raharja', 'L', 'Jalan Mendoan No. 4', 'budiraharja@gmail.com', 082114670146, TO_DATE('01/03/1980','DD/MM/YYYY'), 1, 1);
INSERT INTO KARYAWAN VALUES(2, 'SetyoA', 'SetyoA', 'Setyo Adi', 'L', 'Jalan Pavilion No. 21', 'setyoadi@gmail.com', 082241246613, TO_DATE('23/11/1990','DD/MM/YYYY'), 1, 1);
INSERT INTO KARYAWAN VALUES(3, 'MelianaP', 'MelianaP', 'Meliana Purnama', 'P', 'Jalan Ngagel Jaya No. 26', 'melianapurnama@gmail.com', 081257224666, TO_DATE('07/05/1985','DD/MM/YYYY'), 1, 2);
INSERT INTO KARYAWAN VALUES(4, '', '', '', '', '', '', 0, 0, 0);

-- PELANGGAN
INSERT INTO PELANGGAN VALUES(1, 'RaymondT', 'RaymondT', 'Raymond Tranatung', 'L', 'Jalan Penampungan No. 6', 'raymondt@gmail.com', 08345671222, TO_DATE('10/06/1995','DD/MM/YYYY'), 1);
INSERT INTO PELANGGAN VALUES(2, 'LucianaG', 'LucianaG', 'Luciana Geraldine', 'P', 'Jalan Penampungan No. 9', 'lucianaa@gmail.com', 08512222451, TO_DATE('12/09/1987','DD/MM/YYYY'), 1);
